#!/usr/bin/env python3
"""
Core Logging Modes Utilities
- Centralize logging mode selection across core and apps
...
def apply_logging_mode(mode: Optional[str] = None) -> str:
    ...
    if resolved == "silent":
        ...
        # Ensure root does not emit anywhere unless file handlers are explicitly attached
        try:
