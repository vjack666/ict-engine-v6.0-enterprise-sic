...
class FvgPatternsDashboard(BasePatternDashboard):
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("fvg_patterns", config)
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> FvgPatternsDashboard:
    """Crear instancia del dashboard de fvg_patterns"""
    return FvgPatternsDashboard(config)
