...
class InstitutionalFlowDashboard(BasePatternDashboard):
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("institutional_flow", config)
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> InstitutionalFlowDashboard:
    """Crear instancia del dashboard de institutional_flow"""
    return InstitutionalFlowDashboard(config)
