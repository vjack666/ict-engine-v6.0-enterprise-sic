...
class ChochSingleTfDashboard(BasePatternDashboard):
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("choch_single_tf", config)
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> ChochSingleTfDashboard:
    """Crear instancia del dashboard de choch_single_tf"""
    return ChochSingleTfDashboard(config)
