...
class SwingPointsForBosDashboard(BasePatternDashboard):
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("swing_points_for_bos", config)
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> SwingPointsForBosDashboard:
    """Crear instancia del dashboard de swing_points_for_bos"""
    return SwingPointsForBosDashboard(config)
