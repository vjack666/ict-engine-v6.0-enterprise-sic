...
class FairValueGapsDashboard(BasePatternDashboard):
    """
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> FairValueGapsDashboard:
    """Crear instancia del dashboard de fair_value_gaps"""
    return FairValueGapsDashboard(config)
