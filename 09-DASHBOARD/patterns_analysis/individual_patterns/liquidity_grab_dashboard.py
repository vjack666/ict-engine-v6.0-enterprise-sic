...
class LiquidityGrabDashboard(BasePatternDashboard):
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("liquidity_grab", config)
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> LiquidityGrabDashboard:
    """Crear instancia del dashboard de liquidity_grab"""
    return LiquidityGrabDashboard(config)
