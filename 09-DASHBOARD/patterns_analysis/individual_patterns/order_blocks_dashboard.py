...
class OrderBlocksDashboard(BasePatternDashboard):
    """
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> OrderBlocksDashboard:
    """Crear instancia del dashboard de order_blocks"""
    return OrderBlocksDashboard(config)
