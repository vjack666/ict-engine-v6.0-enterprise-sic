...
class ChochPatternsDashboard(BasePatternDashboard):
    """
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__("choch_patterns", config)
...
def create_dashboard(config: Optional[Dict[str, Any]] = None) -> ChochPatternsDashboard:
    """Crear instancia del dashboard de choch_patterns"""
    return ChochPatternsDashboard(config)
